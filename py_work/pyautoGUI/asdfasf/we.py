...
def city_name():
    api_request = requests.get(
        "https://api.openweathermap.org/data/2.5/weather?q=" + city_entry.get() + "&units=metric&appid=9cb3559e8ebc8eebd428e94fb3c63610")
...
member_Button = Button(root, text="회원 창", command=city_name)
member_Button.grid(row=2, column=1, padx=5, stick=W + E + N + S)
...
label_ondo = Label(root, text="℃", width=0, bg='white', font=("Helvetica", 35), fg='black')
lable_temp.place(x=10, y=220)
label_ondo.place(x=125, y=225)
...
percent = Label(root, text="%", width=0, bg='white', font=("bold", 15))
lable_humidity.place(x=107, y=400)
percent.place(x=150, y=400)
...
ondo1 = Label(root, text="℃", width=0, bg='white', font=("bold", 15))
max_temp.place(x=128, y=430)
ondo1.place(x=185, y=430)
...
ondo2 = Label(root, text="℃", width=0, bg='white', font=("bold", 15))
min_temp.place(x=128, y=460)
ondo2.place(x=185, y=460)
